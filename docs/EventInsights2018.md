...
**faceTheBossAchieved** | **kotlin.Array&lt;kotlin.Float&gt;** | An array with three values, number of times an alliance faced the boss, number of opportunities to face the boss, and percentage. | 
